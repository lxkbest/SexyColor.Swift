//
//  MallNewScrollView.swift
//  SexyColor.Swift
//
//  Created by xiongkai on 2017/9/13.
//  Copyright © 2017年 薛凯凯圆滚滚. All rights reserved.
//

import UIKit

class MallNewScrollView: UIView {
    
    fileprivate var maxCount = 6
    ...
    var minFrame : CGRect = CGRect.zero {
        didSet {
            if minFrame != CGRect.zero {
                ...
                currentImageView = scrollView.subviews[1] as! UIImageView
    ...
    var maxFrame : CGRect = CGRect.zero {
        didSet {
            if maxFrame != CGRect.zero {
                ...
                print(currentImageView.contentMode.rawValue)
            }
    ...
    func startTimer() {
        timer = Timer(timeInterval: 5, target: self, selector: #selector(setNext), userInfo: nil, repeats: true)
...
extension MallNewScrollView : UIScrollViewDelegate {
